...
<body>
  ...
  <div class="container py-5 h-100">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-xl-10">
        <div class="card rounded rounded-3 text-black shadow px-3 px-lg-0 pb-3 pb-lg-0">
          <div class="row g-0">
            <div class="col-lg-6 border border-5 border-pink">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form action="{{ route('registerSubmit') }}" method="POST" onsubmit="document.getElementById('submit').disabled=true;">
                  @csrf
                  <p class="fs-5 fst-italic">~ Please enter the following details.</p>
                 ...
                 <!--  @if($errors->any())
                  ...
                  <div class="text-center pt-1 mb-5 pb-1 d-grid d-lg-block">
                    <button class="btn btn-primary btn-block fa-lg mb-3 me-2 hero-btn1" type="submit" id="submit"><i class="bi bi-person-arms-up me-2"></i>Register</button>
                    <!-- <a class="text-muted" href="#!">Forgot password?</a> -->
                  </div>

                  <div class="d-flex align-items-center justify-content-center pb-4">
                    <p class="mb-0 me-2 fs-5">Already have an account?</p>
                    <!-- <button  type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-dark">Log in</button> -->
                    <a href="{{ route('login') }}" class="btn btn-outline-dark w-50">Log in</a>
                  </div>
